// a module that exports action functions to be used in the reducer function for REDUX state managment
...
export async function unFriend(id) {
    try {
        await instance.post("/friendshipStatus", {
            buttonMode: "End Friendship",
            id: id
        });
        return {
            type: "UNFRIEND",
        ...
        console.log("Error in action creator unFriend: ", err.message);
    }
}
export async function acceptFriend(id) {
    try {
        await instance.post("/friendshipStatus", {
            buttonMode: "Accept Friendship Request",
            id: id
        });
        return {
            type: "ACCEPT_FRIEND",
        ...
        console.log("Error in action creator acceptFriend: ", err.message);
    }
}
export async function cancelRequest(id) {
    try {
        await instance.post("/friendshipStatus", {
            buttonMode: "Cancel Friendship Request",
            id: id
        });
        return {
            type: "CANCEL_REQUEST",
        ...
        console.log("Error in action creator cancelRequest: ", err.message);
    }
}
