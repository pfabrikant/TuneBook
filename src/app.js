                ...
                <BrowserRouter>
                    <div>
                        <Header first={this.state.first}
                            ...
                            avatarUrl={this.state.avatarurl|| '../public/avatar.jpg'}
                        ...
                        <Route path="/users/:id" component={OtherUsersProfiles}/>
                        <Route path="/search-users" component={SearchUsers}/>
                        <Route path="/search-instruments" component={SearchInstrument}/>
